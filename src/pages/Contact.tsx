...
const Contact: React.FC = () => {
  ...
  return (
    <div className="text-gray-800">
      ...
      <div className="bg-slate-50 shadow-lg rounded-xl mx-auto max-w-6xl mt-[-80px] relative z-20 p-8">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    <a href="mailto:support@jewelmart.com" className="hover:text-rose-600 transition-colors">
                      support@jewelmart.com
                    </a><br />
                    <a href="mailto:sales@jewelmart.com" className="hover:text-rose-600 transition-colors">
                      sales@jewelmart.com
                    </a>
                  </p>
                </div>
